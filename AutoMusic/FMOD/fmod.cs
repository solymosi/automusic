...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00042805;
#if WIN64
    ...
    */
    public enum INITFLAGS :int
    {
        ...
        DTS_NEURALSURROUND      = 0x02000000,   /* Win32/Mac/Linux/Solaris - Use DTS Neural surround downmixing from 7.1 if speakermode set to FMOD_SPEAKERMODE_STEREO or FMOD_SPEAKERMODE_5POINT1.  Internal DSP structure will be set to 7.1. */
    ...
    */
    ...
    public struct REVERB_CHANNELFLAGS
    {
        ...
        public const uint INSTANCE0     = 0x00000010; /* EAX4/SFX/GameCube/Wii. Specify channel to target reverb instance 0.  Default target. */
        public const uint INSTANCE1     = 0x00000020; /* EAX4/SFX/GameCube/Wii. Specify channel to target reverb instance 1. */
        public const uint INSTANCE2     = 0x00000040; /* EAX4/SFX/GameCube/Wii. Specify channel to target reverb instance 2. */
        public const uint INSTANCE3     = 0x00000080; /* EAX5/SFX. Specify channel to target reverb instance 3. */
    ...
    */
    ...
    {                       
        ...
        public uint    geometryThreadPeriod;     /* [in/out] Optional. Specify 0 to ignore. Thread period for FMOD geometry thread. */
    }
    ...
    */
    public class System
    {
        ...
        public RESULT setFileSystem          (FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek, int blockalign)
        {
            return FMOD_System_SetFileSystem(systemraw, useropen, userclose, userread, userseek, blockalign);
        }
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_SetFileSystem          (IntPtr system, FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek, int blockalign);
        [DllImport (VERSION.dll)]
    ...
    */
    public class SoundGroup
    {
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_SoundGroup_GetMemoryInfo      (IntPtr soundgroup, uint memorybits, uint event_memorybits, ref uint memoryused, IntPtr memoryused_array);
        #endregion
